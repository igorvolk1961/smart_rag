"""
Web Search tool для поиска в интернете.
Адаптировано из sgr-agent-core с использованием TavilySearchService.
"""
...
from api.agents.models import SearchResult
from api.agents.services.tavily_search import TavilySearchService
...
class WebSearchTool(BaseTool):
    ...
    async def __call__(self, context: AgentContext, config: AgentConfig, **_) -> str:
        ...
        if not config.search or not config.search.tavily_api_key:
