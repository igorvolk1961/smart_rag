"""
Реестр для управления классами агентов и tools.
...
if TYPE_CHECKING:
    from api.agents.base_agent import BaseAgent  # noqa: F401
    from api.agents.base_tool import BaseTool  # noqa: F401
